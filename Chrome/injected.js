            ...
            for (let i = 0; i < Loop; i++) {
                ...
                if (i == 0) {
                    ...
                    state.expressions.list.push({
                        ...
                        folderId: folderId.toString(),
                        color: "#c74440",
                        latex: "G_{" + g[i] + "}=[" + G.slice((i * 10000) - 10000, (i * 10000)) + "]",
                        hidden: true
                    });
                    state.expressions.list.push({
                        type: "expression",
                        ...
                        folderId: folderId.toString(),
                        color: "#c74440",
                        latex: "B_{" + b[i] + "}=[" + B.slice((i * 10000) - 10000, (i * 10000)) + "]",
                        hidden: true
                    });
                }
            }
